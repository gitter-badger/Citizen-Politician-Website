...
class NavBar {
	...
	public function index(){
		return "<nav class='navbar navbar-expand-sm navbar-light fixed-bottom' style='background-color: #ced4da;padding-top:2px;padding-bottom:2px;'><button class='navbar-toggler' type='button' data-toggle='collapse' data-target='#smallScreen' style='outline: none;'><span class='navbar-toggler-icon'></span></button><div class='collapse navbar-collapse' id='smallScreen' style='font-family: Comic Sans MS,cursive,sans-serif;font-size:13px'><ul class='navbar-nav'><li class='nav-item'><a class='nav-link' href='#main'><i class='fas fa-home'></i> Home</a></li><li class='nav-item'><a class='nav-link' href='#contacts'><i class='fas fa-envelope'></i> Contacts</a></li><li class='nav-item'><a class='nav-link' href='#faq'><i class='fas fa-question-circle'></i> FAQs</a></li></ul></div><a class='ml-auto navbar-brand text-dark' href='".base_url()."' style='font-family: Cookie,cursive;font-size:17px'><i class='fas fa-user'></i> Mwananchi &copy; 2018</a></nav>";
	}

	public function admin_nav_bar(){
		return "<nav class='navbar bg-info navbar-expand-lg navbar-dark fixed-top' style='padding-top:2px;padding-bottom:2px;'><a class='navbar-brand text-dark' href='".base_url()."' style='font-family: Cookie,cursive;'><i class='fas fa-user'></i> Mwananchi</a><button class='navbar-toggler' type='button' data-toggle='collapse' data-target='#smallScreen' style='outline: none;'><span class='navbar-toggler-icon'></span></button><div class='collapse navbar-collapse' id='smallScreen'><ul class='navbar-nav'><li class='nav-item'><a class='nav-link' href='".base_url()."news_feed.html'>Home</a></li><li class='nav-item'><a class='nav-link' href=''>Site Settings</a></li><li class='nav-item'><a class='nav-link' href='".site_url('functions')."'>Politician Roles</a></li><li class='nav-item'><a class='nav-link' href='".site_url("start_poll")."'>Start Poll</a></li></ul><ul class='navbar-nav ml-auto'><li class='nav-item'><a class='nav-link' href='".site_url("settings")."'><span class='fas fa-cog'></span> Settings</a></li><li class='nav-item' style='width: 50px;text-align: center;white-space: nowrap;' data-toggle='popover' title='Recent Notifications' data-trigger='click' data-placement='bottom' data-content='".implode($this->get_notifications())."'><a class='nav-link'><span class='fas fa-bell'></span> <sup class='badge badge-secondary' style='text-align: center;white-space: nowrap;'>".$this->get_notification_count()."</sup></a></li><li class='nav-item dropdown'><a class='nav-link dropdown-toggle' data-toggle='dropdown' href=''><span class='rounded'><img class='rounded' src='".$this->ci->session->userdata("photo")."' width='25px' height='25px' style='width: 25px;height:25px;'></span> More Links </a>
		    			<div class='dropdown-menu bg-info' style='padding: 3px;border-radius: 5px;padding-top: 13px;margin-top:-0.01px;'>
				    			<a class='nav-item nav-link' href=''>Send Email</a>
				    			<a class='nav-item nav-link' href='".site_url("register")."'>Add Admin</a>
				    			<a class='nav-item nav-link' href='".site_url("drop_accounts")."'>Drop Accounts</a>
	...
	private function get_notifications(){
		...
		array_push($content,"<a href=\"".site_url('notifications')."\" class=\"text-light mb-3\">See All</a>");
		return $content;
	}
