	...
	public function get_activity_count($data){
		if(is_object($data)){
			if($data->type==="admin"){
				...
				return "<ul class='nav nav-tabs p-2 row ml-1 mr-1'><span class='row col-xs'><li class='col-xs nav-item mr-5 d-flex align-items-center'><strong class='mr-2'>Shares</strong> <span class='badge badge-info ml-auto'>12</span></li><li class=' col-xs mr-5 d-flex nav-item align-items-center'><strong class='mr-2'>Likes</strong> <span class='badge badge-info ml-auto'>3</span></li><li class='col-xs d-flex nav-item mr-5 align-items-center'><strong class='mr-2'>Posts</strong> <span class='badge badge-info ml-auto'>7</span></li><li class='col-xs nav-item mr-5 d-flex align-items-center'><strong class='mr-2'>Following</strong> <span class='badge badge-info ml-auto'>178</span></li></span><li class='col-xs ml-auto nav-item text-muted d-flex' style='font-family: Cookie,cursive;'><i class='fas fa-user'></i> Mwananchi</li></ul>";
			}elseif($data->type==="politician"){
				return "<ul class='nav nav-tabs p-2 row ml-1 mr-1'><span class='row col-xs'><li class='col-xs nav-item mr-5 d-flex align-items-center'><strong class='mr-2'>Posts</strong> <span class='badge badge-info ml-auto'>7</span></li><li class='col-xs nav-item mr-5 d-flex align-items-center'><strong class='mr-2'>Followers</strong> <span class='badge badge-info ml-auto'>178</span></li></span><li class='col-xs nav-item ml-auto text-muted' style='font-family: Cookie,cursive;'><i class='fas fa-user'></i> Mwananchi</li></ul>";
			}
		}
		redirect(base_url()."home.html","location");
	}
