	...
	public function get_activity_count_html(){
		if(null!==$this->session->userdata("username")){
			if($this->session->userdata("usertype")==="admin"){
				...
				return "<ul class='list-group w-75 ml-auto mr-auto' style='overflow-x: auto;'><li class='list-group-item list-group-item-secondary d-flex justify-content-between align-items-center'><div>Activity</div> <i class='fab fa-hotjar'></i></li><li class='list-group-item d-flex justify-content-between align-items-center'><strong>Shares</strong> <span class='badge badge-info ml-auto' id='shares'>".$this->get_shares($this->session->userdata("username"))."</span></li><li class='list-group-item d-flex justify-content-between align-items-center'><strong>Likes</strong> <span class='badge badge-info ml-auto' id='likes'>".$this->get_likes($this->session->userdata("username"))."</span></li><li class='list-group-item d-flex justify-content-between align-items-center'><strong>Posts</strong> <span class='badge badge-info ml-auto' id='posts'>".$this->get_posts($this->session->userdata("username"))."</span></li><li class='list-group-item d-flex justify-content-between align-items-center'><strong>Following</strong> <span class='badge badge-info ml-auto'>".$this->get_following($this->session->userdata("username"))."</span></li></ul><hr><hr>";
