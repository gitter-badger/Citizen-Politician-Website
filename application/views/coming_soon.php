...
<body>
	<div class="container-fluid text-center mb-5" style="position: relative;top: 60px;">
		...
		<div class="container text-muted mt-3">
			...
			<p class="mt-3">Our developers are working day and night to ensure the feature is made available ASAP! We are sorry if this has caused you any inconvenience. Feel free to contact us any time from <a class="text-info" href="<?php echo site_url('about')?>">here.</a></p>
			<p>For more information about this feature, visit our <a class="text-info" href="<?php echo site_url('features')?>">features</a> page. If you would like to help in the development of this feature then visit the <a href="<?php echo site_url('dev_zone')?>" class="text-info">dev_zone</a>. For Frequently Asked Questions, visit our <a class="text-info" href="<?php echo site_url('help')?>">FAQ page.</a></p>
			<div class="d-flex justify-content-center mt-3 mb-3"><a class="text-info" href="<?php echo base_url()?>" style="font-size: 18px;font-family: Cookie,cursive;"><i class="fas fa-user"></i> Mwananchi</a> - Leadership with Service.</div>
