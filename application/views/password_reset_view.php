...
::selection { background-color: limegreen; color: white; }
::-moz-selection { background-color: limegreen; color: white; }
...
<body>
	<div id="container">
		<h1><span style="font-size: 26px;"><i class="fas fa-user"></i> <span style="font-family: Cookie,cursive;">Mwananchi</span></span> - Password Reset Page.</h1>
		<div class="container"><?php echo $data; ?></div>
	</div>
</body>
</html>