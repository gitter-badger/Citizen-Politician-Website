	    ...
	    <?php
	    	...
	    	if(isset($_SESSION['username'])){
	    		...
	    		if(mysqli_num_rows($notifications)>0){
					...
					$content= array('No New Notifications to display.');
				}
		    	if($_SESSION['usertype']==="admin"){
		    		echo "<ul class='navbar-nav'><li class='nav-item navigationBar'><a class='nav-link text-light' href='Functions.php'>Politician Roles</a></li><li class='nav-item navigationBar'><a class='nav-link text-light' href='SiteSettings.php'>Site Settings</a></li><li class='nav-item navigationBar'><a class='nav-link text-light' href='OpinionPolls.php'>Start Poll</a></li></ul><ul class='navbar-nav ml-auto'><li class='nav-item navigationBar'><a class='nav-link text-light' href='Settings.php'><span class='fas fa-cog'></span> Settings</a></li><li class='nav-item' style='width: 50px;text-align: center;white-space: nowrap;' data-toggle='popover' title='Recent Notifications' data-trigger='hover' data-placement='bottom' data-content='".implode($content)."'><a class='nav-link text-light' href='Notifications.php'><span class='fas fa-bell'></span> <sup class='badge badge-dark' style='text-align: center;white-space: nowrap;'>$messages</sup></a></li><li class='nav-item dropdown navigationBar'><a class='nav-link dropdown-toggle text-light' data-toggle='dropdown' href=''><span class='rounded'><img class='rounded' src='$photo' width='25px' height='25px' style='width: 25px;height:25px;'></span> My Profile </a>
